  ...
  if ($result->num_rows > 0) {
    ...
    <html>
      ...
      <body>
        ...
        <h3><a href='http://www.gotoknowdrugs.shareforproject.com/pages/update_password.php?email=$email&id=$id' target='_blank'>click for reset password</a></h3>
      </body>
    </html>
    ");
    if (!$mail->send()) {
    ...
    $resp["result"] = true;
    $resp["message"] = "กรุณาตรวจสอบอีเมล์ของท่าน $email เพื่อทำการเปลี่ยนรหัสผ่าน";
  } else {
    $resp["result"] = false;
